import { Controller, Get, Put, Post, Delete, Query, Param, Body, Req } from "@nestjs/common";
...
import { Perm } from "../../../shared/decorators/auth.decorators";
import { RequireSuperAdmin } from "../../../shared/decorators/auth.decorators";
 ...
 * 与前端菜单权限码对齐。迁到 partner-service 后鉴权全靠全局
 * IntrospectAuthGuard(见 shared/guards/introspect-auth.guard.ts),
 * 不再需要局部 JwtAuthGuard/SuperAdminGuard
 */
@ApiTags("合伙人管理后台")
@ApiBearerAuth()
