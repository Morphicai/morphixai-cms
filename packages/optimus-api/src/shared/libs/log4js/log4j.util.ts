...
import { getLogLevelString, isProduction } from "../../utils/env.util";
...
Log4js.configure({
    ...
    categories: {
        ...
        http: { appenders: ["access"], level: getLogLevelString() },
    },
...
logger.level = isProduction() ? LoggerLevel.INFO : LoggerLevel.TRACE;
